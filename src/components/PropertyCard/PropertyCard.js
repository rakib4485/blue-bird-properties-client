...
const PropertyCard = ({offer}) => {
    const {img, title,location, price } = offer;
    return (
        <div>
            <article className="cursor-pointer transform duration-500 hover:-translate-y-1">
            <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                <div className="bg-cover bg-center h-80 p-4" style={{backgroundImage: `url(${img})`}}>
              ...
              <path
                ...
                <div className="p-4 py-5">
                    ...
                    <p className="text-3xl text-gray-900 mt-1.5 mb-1.5">৳{price}</p>
              ...
              <path fill-rule="evenodd"
                ...
                <div className="px-4 pt-3 pb-4 border-t border-gray-200 bg-gray-100">
                    ...
                    <div className="flex items-center pt-2">
                        <div className="bg-cover bg-center w-10 h-10 rounded-full mr-3" style={{backgroundImage:" url(https://st.depositphotos.com/1067257/2844/v/600/depositphotos_28440617-stock-illustration-black-and-white-human-skull.jpg)"}}>
                        </div>
                        <div>
