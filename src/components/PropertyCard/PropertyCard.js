...
const PropertyCard = ({ property }) => {
    const { _id, image, propertyName, location, rent, bedroom, bath } = property;
    return (
        <div>
            ...
            <article className="cursor-pointer transform duration-500 hover:-translate-y-1">
                <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                    ...
                    <div className="p-4 py-5">
                        ...
                        <p className="text-3xl text-gray-900 mt-1.5 mb-1.5">৳ {rent}</p>
                    ...
                    <div className="flex p-4 border-t border-gray-200 text-gray-700">
                        <div className="flex-1 inline-flex items-center">
                            ...
                            <p><span className="text-gray-900 font-bold">{bedroom}</span> Bedrooms</p>
                        </div>
                        <div className="flex-1 inline-flex items-center">
                            <svg className="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <p><span className="text-gray-900 font-bold">{bath}</span> Bathrooms</p>
                        </div>
                    </div>
                </div>
            </article>
